...
Поиск информации о графических адаптерах (видеокартах) в списке всех PCI‑устройств системы:
    $ lspci | grep -i 'vga\|3d\|2d'
Информация о графическом устройстве (видеокарте), которое система использует для рендеринга OpenGL‑график:
